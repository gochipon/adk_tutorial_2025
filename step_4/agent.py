...
from .session import create_session, APP_NAME
...
if greeting_agent and farewell_agent and 'get_weather_stateful' in globals():
    ...
    root_agent= Agent(
        ...
        tools=[get_weather_stateful, set_temperature_unit], # Root agent tools
    ...
    runner = Runner(
        agent=root_agent,
        app_name=APP_NAME,
        session_service= create_session() # Use the NEW stateful session service
    )
